...
class AuthService:
    ...
    async def login(
        ...
        # Verify password (check_password handles failed attempts tracking and reset on success)
        ...
        # Successful login - update last login (check_password already reset failed_login_attempts)
